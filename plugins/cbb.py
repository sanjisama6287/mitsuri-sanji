...
💵 UPI ID - Contact <a href="https://t.me/Syfer_Admin_Bot">Syfer</a>\n
📸 QR - <a href="https://envs.sh/UvX.jpg">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>\n
♻️ <b>Please Contact Admin For Any Type Of Support You Want From Us !!</b>'''
...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        ...
        btn = [[
            InlineKeyboardButton('📬    Contact OWNER to Buy Plan', url="https://t.me/Syfer_Admin_Bot")
        ],[
