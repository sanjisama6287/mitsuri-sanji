...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7708046640:AAE7CoL-hsLTjFO91FzYfSTuxTXcoZzfhe8")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002365865779"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002379399595"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7162615398 7827448605 1439890119 5696112220 6076683960").split()):
        ADMINS.append(int(x))
except ValueError:
